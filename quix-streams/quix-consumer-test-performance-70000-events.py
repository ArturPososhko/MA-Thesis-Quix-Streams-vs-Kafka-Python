...
uptime_duration = 59  # Uptime of the consumer in seconds
...
# Configure logging
log_file = "quix_consumer_performance_70000_events_per_sec_logs.txt"
...
def quix_consumer():
    ...
    _app = Application(broker_address=os.environ.get("BROKER_ADDRESS", "localhost:9092"),
                       consumer_group="quix-performance-70000-events-consumer",
...
def print_consumer_metrics():
    ...
    plt.tight_layout()
    plt.savefig("quix_consumer_performance_70000_events_metrics.png")
    plt.show()
